...
int main() {
    ...
    engine.updateItemZone("004", "Storage");
    engine.updateItemZone("005", "Laboratory");
    engine.updateItemZone("006", "Life Support");
    engine.updateItemZone("007", "Crew Quarters");
    engine.updateItemZone("008", "Exterior");
    engine.updateItemZone("009", "Medical Bay");
    engine.updateItemZone("010", "Airlock");
